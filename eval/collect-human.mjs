...
// HTML-entity cleanup applied) to eval/samples/human/*.txt and records
// provenance in eval/samples/human/SOURCES.tsv.
//
...
const OUT_DIR = path.join(__dirname, "samples", "human");
const SOURCES_TSV = path.join(OUT_DIR, "SOURCES.tsv");

const UA = "SlopAlarmCalibration/1.0 (+https://github.com/damienen/slop-alarm)";
const MIN_WORDS = 150;
const MAX_WORDS = 400;
